	...
	<div class="installation-section padding-bottom padding-top">
		<div class="container">
			...
			function getStatus($arr){
				$url = 'https://license.nulljungle.com/hyiplab/api';
				$arr['product'] = 'hyiplab';
				$call = $url . "?" . http_build_query($arr);
				return curlContent($call); 
			}
			function sendAcknoledgement($val){
				$call = 'https://license.nulljungle.com/hyiplab/done/'.$val->installcode;
				return curlContent($call); 
			}
						...
						<div class="install-item">
							...
							<div class="box-item">
								<form action="?action=complete" method="post" class="information-form-area mb--20">
									...
									<div class="info-item">
										<h5 class="font-weight-normal mb-2">Purchase Verification - Nulled By NUllJungle.com</h5>
										<div class="row">
											<div class="information-form-group col-sm-6">
												<input type="text" name="user" placeholder="Username" value="NullJungle.com" required>
											</div>
											<div class="information-form-group col-sm-6">
												<input type="text" name="code" placeholder="Purchase Code" value="NullJungle.com" required>
											</div>
										</div>
									</div>
									<div class="info-item">
					...
					<div class="install-content-area">
						<div class="install-item">
							...
							<div class="box-item">
								...
								<div class="item">
									<p class="info">For more information, Please Check <a href="https://NullJungle.com" target="_blank">NullJungle.com</a></p>
								</div>
								<div class="item text-right">
